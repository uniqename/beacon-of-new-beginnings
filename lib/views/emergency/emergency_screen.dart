...
class _EmergencyScreenState extends State<EmergencyScreen> {
  ...
  void _showEmergencyNumber(String phoneNumber, String serviceName) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text('$serviceName Emergency'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('Emergency Number: $phoneNumber'),
            const SizedBox(height: 16),
            const Text('Please dial this number directly on your phone to contact emergency services.'),
          ],
        ),
        actions: [
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('$phoneNumber copied to clipboard')),
              );
            },
          ...
          child: Column(
            ...
            children: [
              ...
              _EmergencyActionCard(
                ...
                color: Colors.red,
                onTap: () => _showEmergencyNumber('999', 'Ghana Emergency Services'),
              ),
              ...
              _EmergencyActionCard(
                ...
                color: Colors.orange,
                onTap: () => _showEmergencyNumber('+233XXXXXXX', 'Crisis Helpline'),
              ),
