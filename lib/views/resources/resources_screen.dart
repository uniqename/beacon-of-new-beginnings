...
class _ResourcesScreenState extends State<ResourcesScreen> with TickerProviderStateMixin {
  ...
  void _showContactInfo(String contact, String type) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('Please use this information to contact the resource directly.'),
          ],
        ),
        actions: [
          TextButton(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _ResourceCard(
                        ...
                        onCall: resource.phone != null
                            ? () => _showContactInfo(resource.phone!, 'Phone')
                            : null,
                        onEmail: resource.email != null
                            ? () => _showContactInfo(resource.email!, 'Email')
                            : null,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        resource.status == ResourceStatus.available ? '✅ Available' : '🔄 Limited',
                        style: TextStyle(
